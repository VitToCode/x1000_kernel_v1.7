...
static void ft5x0x_ts_power_on(struct ft5x0x_ts_data *ts)
{
...
static void ft5x0x_ts_power_off(struct ft5x0x_ts_data *ft5x0x_ts)
{
#ifdef GPIO_FT5X0X_EN
...
static int ft5x0x_read_data(void)
{
	...
	switch (event->touch_point) {
		...
		case 5:
			...
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_X
			ft5406_swap_x(&(event->x5),pdata->x_res);
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_Y
			ft5406_swap_y(&(event->y5),pdata->y_res);
			#endif
		...
		case 4:
			...
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_X
			ft5406_swap_x(&(event->x4),pdata->x_res);
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_Y
			ft5406_swap_y(&(event->y4),pdata->y_res);
			#endif
		...
		case 3:
			...
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_X
			ft5406_swap_x(&(event->x3),pdata->x_res);
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_Y
			ft5406_swap_y(&(event->y3),pdata->y_res);
			#endif
		...
		case 2:
			...
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_X
			ft5406_swap_x(&(event->x2),pdata->x_res);
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_Y
			ft5406_swap_y(&(event->y2),pdata->y_res);
			#endif
		...
		case 1:
			...
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_X
			ft5406_swap_x(&(event->x1),pdata->x_res);
			#endif
			#ifdef CONFIG_FT5X0X_SWAP_Y
			ft5406_swap_y(&(event->y1),pdata->y_res);
			#endif
