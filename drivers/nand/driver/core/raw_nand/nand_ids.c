...
NAND_FLASH_DEV nand_flash_chips[] =
{
	/*
        {name              		id        	extid           planes  dienum
                tals	talh	trp	twp     trhw	twhr	pagesize        blocksize
                oobsize cycle maxbadblocks maxvalidblocks eccblock  eccbit  buswidth  badblockpos options}
	*/
        {"TOSHIBA_TC58NVG2S3ETA00",     0x98DC,         0x00761590,     2,      1,
                12,	5,	12,	12,	100,	60,	2048,   128*1024,
                64, 	3,	100,	4096,	512,	4,	8,	0,	0},

	{"SAMSUNG_K9F1208U0C",	  	0xEC76,		0x00743F5A,	1,	1,
                12,	5,	12,	12,	100,	60,	512,	16*1024,
                16, 	3,	100,	4096,	512,	8,	8,	0,	0},

	{"HYNIX_HY27UF084G2B",	        0xADDC,	        0x00549510,	1,	1,
                15,	5,	15,	15,	60,	60,	2048,	128*1024,
                64, 	3,	80,	4096,	512,	1,	0,	0,	LP_OPTIONS},

	{"MICRON_MT29F64G08CFAAA",	0x2CD7,		0x00843E94,	2,	1,
                10,	5,	10,	10,	100,	60,	4096,	512*1024,
                218,	3,	400,	4096*4,	539,	12,	8,	0,	LP_OPTIONS},

	{"SAMSUNG_K9GAG08U0D", 		0xECD5,		0x41342994,	2,	1,
                15,	5,	15,	15,	100,	60,	4096,	512*1024,
                218, 	3,	100,	8192,	512,	8,	8,	0,	LP_OPTIONS},

	{"SAMSUNG_K9GAG08U0M", 		0xECD5,		0x0074b614,	2,	1,
                12,	5,	12,	12,	100,	60,	4096,	512*1024,
                128, 	3,	100,	4096,	512,	4,	8,	0,	LP_OPTIONS},

	{"SAMSUNG_K9GAG08U0E", 		0xECD5,		0x42507284,	2,	1,
                12,	5,	12,	12,	100,	60,	8192,	1024*1024,
                436, 	3,	100,	2048,	512,	8,	8,	0,	LP_OPTIONS},
	...
	{"SAMSUNG_K9GBG08U0A",          0xECD7,		0x43547A94, 	2,	1,
                12,     5,  	25,	25,	100,    120,     8192,	1024*1024,
                640,    3,	116,	4152,	1024,   24,	8,	0,     	LP_OPTIONS},

	{"HYNIX_H8BCS0UN0MCR",          0xADBC,	 	0x00545510,	1,	1,
                25,	10,	25,	25,	100,	60,	2048,	128*1024,
                64,	3,	80,	4096,	512,	4,	16,	0,	LP_OPTIONS16},

	{"SAMSUNG_K9G8G08U0M",          0xECD3, 	0x00642514,	2,	1,
                15,	5,	15,     15,	60,   	60,  	2048,	256*1024,
                64,     3,	100,	4096,	512,	4,	8,	0,	LP_OPTIONS},

	{"SAMSUNG_K9F1G08U0B",          0xECF1,		0x00409500,    	1,	1,
                15,	5,	15,	15,	100,	60, 	2048,	128*1024,
                64, 	3,	20,	1024,	512,	1,	8,	0,	LP_OPTIONS},

	{"SAMSUNG_K9F1G08U0M",		0xECF1,         0,	        1,	1,
                15,	5,	15,	15,     100, 	60,	2048,	128*1024,
                64, 	3,	20,	1024,	512,	4,	8,	0,	LP_OPTIONS},

	{"SAMSUNG_K9HBG08U1M",		0xECD5, 	0x00682555,  	2,	2,
                15,	5,	15,	15,     100,	60,	2048,	256*1024,
                64, 	3,	200,	8192,	512,	4,	8,	0,	LP_OPTIONS},

	{"SAMSUNG_K9LBG08U0M",		0xECD7, 	0x0078B655,     1,	1,
                12,	5,	15,	15,	100,	60,	4096,	512*1024,
                64, 	3,     	200,	8192,	512,	4,	8,	0,	LP_OPTIONS},
	{"MICRON_MT29F32G08CBACA",      0x2C68,         0x00A94A04,     2,	1,
                10,     5,   	10,	10,  	100,    60,     4096,   1024*1024,
                224,	3,	100,	4096,	1024,	24,	8,	0,	LP_OPTIONS},
