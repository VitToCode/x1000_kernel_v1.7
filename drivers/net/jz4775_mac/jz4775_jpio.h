 ...
 *
 * JZ4775 GPIO register definition.
 *
 * Copyright (C) 2012 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4775GPIO_H__
#define __JZ4775GPIO_H__
...
#define __gpio_as_uart4()		\
	do {					\
		__gpio_as_func2(GPC(10));	\
		__gpio_as_func2(GPC(20));	\
	} while (0)
...
#define __gpio_as_nand_16bit(n)						\
	do {		              						\
		REG_GPIO_PXINTC(6) =  0x0003fc00; /* SD8~SD15:GG_10:17 */ \
		REG_GPIO_PXMASKC(6) = 0x0003fc00;				\
		REG_GPIO_PXPAT1C(6) = 0x0003fc00;				\
		REG_GPIO_PXPAT0S(6) = 0x0003fc00;				\
		REG_GPIO_PXPENS(6) =  0x0003fc00;				\
										\
		REG_GPIO_PXINTC(0) =  0x000c00ff; /* SD0 ~ SD7(GA_0:7), CS1#(GA_21), FRE#(GA_18), FWE#(GA_19) */ \
		REG_GPIO_PXMASKC(0) = 0x000c00ff;				\
		REG_GPIO_PXPAT1C(0) = 0x000c00ff;				\
		REG_GPIO_PXPAT0C(0) = 0x000c00ff;				\
		REG_GPIO_PXPENS(0) =  0x000c00ff;				\
 ...
 */
#define __gpio_as_cim_8bit(n)					\
	do {						\
		REG_GPIO_PXINTC((n)*5+1) = 0x0003ffc0;	\
		REG_GPIO_PXMASKC((n)*5+1) = 0x0003ffc0;		\
		REG_GPIO_PXPAT1C((n)*5+1) = 0x0003ffc0;	\
		REG_GPIO_PXPAT0C((n)*5+1) = 0x0003ffc0;	\
	} while (0)
/*
 * CIM0: GPB[17:6]
 */
 ...
 * CIM1: GPG[17:6]
 */
#define __gpio_as_cim1_8bit()					\
	do {						\
		REG_GPIO_PXINTC(6) = 0x0003ffc0;	\
		REG_GPIO_PXMASKC(6) = 0x0003ffc0;	\
		REG_GPIO_PXPAT1C(6) = 0x0003ffc0;	\
		REG_GPIO_PXPAT0C(6) = 0x0003ffc0;	\
	} while (0)
...
#define __gpio_as_msc0_4bit()			\
	do {						\
		REG_GPIO_PXINTC(0)  = 0xfc0000;		\
		REG_GPIO_PXMASKC(0) = 0xfc0000;		\
		REG_GPIO_PXPAT1C(0) = 0xfc0000;		\
		REG_GPIO_PXPAT0S(0) = 0xfc0000;		\
	} while (0)
 ...
 */
#define __gpio_as_msc 	__gpio_as_msc0_8bit /* default as msc0 4bit */
#define __gpio_as_msc0 	__gpio_as_msc0_8bit /* msc0 default as 4bit */
...
#define __gpio_as_ssi0()				\
	do {						\
		REG_GPIO_PXINTC(3) = 0x01B00000;	\
		REG_GPIO_PXMASKC(3) = 0x01B00000;	\
		REG_GPIO_PXPAT1C(3) = 0x01B00000;	\
		REG_GPIO_PXPAT0C(3) = 0x01B00000;	\
	} while (0)
#else
#define __gpio_as_ssi0()
#endif
 ...
 * I2C_SCK, I2C_SDA
 */
/* i2c0 : PD 30 and 31 func 0 I2c1: PE 30 and 31 func 0*/
