...
#define DEF_CLK(N,FLAG)						\
	...
	DEF_CLK(VPU,  		GATE(12) | PARENT(H0CLK)),
	DEF_CLK(SADC,  		GATE(13)),
	DEF_CLK(UART0, 		GATE(14) | PARENT(EXT1)),
	DEF_CLK(UART1, 		GATE(15) | PARENT(EXT1)),
	DEF_CLK(UART2, 		GATE(16) | PARENT(EXT1)),
	DEF_CLK(DMIC,  		GATE(17) | PARENT(CGU_I2S)),
	DEF_CLK(TCU,  		GATE(18)),
	DEF_CLK(SSI,  		GATE(19)),
	DEF_CLK(SYS_OST,	GATE(20)),
	DEF_CLK(PDMA,  		GATE(21)),
	DEF_CLK(CIM,  		GATE(22) | PARENT(CGU_CIM)),
	DEF_CLK(LCD,  		GATE(23) | PARENT(CGU_LCD)),
	DEF_CLK(AES,  		GATE(24)),
	DEF_CLK(MAC,  		GATE(25)),
	DEF_CLK(PCM,  		GATE(26) | PARENT(CGU_PCM)),
	DEF_CLK(RTC,  		GATE(27)),
