...
static struct smart_lcd_data_table xrm2002903_data_table[] = {
	{SMART_CONFIG_CMD,	0x0001},{SMART_CONFIG_DATA,	0x011c},
	{SMART_CONFIG_CMD,	0x0002},{SMART_CONFIG_DATA,	0x0100},
	{SMART_CONFIG_CMD,	0x0003},{SMART_CONFIG_DATA,	0x1230},
	{SMART_CONFIG_CMD,	0x0008},{SMART_CONFIG_DATA,	0x0808},
	{SMART_CONFIG_CMD,	0x000c},{SMART_CONFIG_DATA,	0x0000},
	{SMART_CONFIG_CMD,	0x000f},{SMART_CONFIG_DATA,	0x0e01},
	{SMART_CONFIG_CMD,	0x0020},{SMART_CONFIG_DATA,	0x0000},
	{SMART_CONFIG_CMD,	0x0021},{SMART_CONFIG_DATA,	0x0000},{SMART_CONFIG_UDELAY,10},
	{SMART_CONFIG_CMD,	0x0010},{SMART_CONFIG_DATA,	0x0a00},
	{SMART_CONFIG_CMD,	0x0011},{SMART_CONFIG_DATA,	0x1038},{SMART_CONFIG_UDELAY,10},
	{SMART_CONFIG_CMD,	0x0030},{SMART_CONFIG_DATA,	0x0000},
	{SMART_CONFIG_CMD,	0x0031},{SMART_CONFIG_DATA,	0x00db},
	{SMART_CONFIG_CMD,	0x0032},{SMART_CONFIG_DATA,	0x0000},
	{SMART_CONFIG_CMD,	0x0033},{SMART_CONFIG_DATA,	0x0000},
	{SMART_CONFIG_CMD,	0x0034},{SMART_CONFIG_DATA,	0x00db},
	{SMART_CONFIG_CMD,	0x0035},{SMART_CONFIG_DATA,	0x0000},
	{SMART_CONFIG_CMD,	0x0036},{SMART_CONFIG_DATA,	0x00af},
	{SMART_CONFIG_CMD,	0x0037},{SMART_CONFIG_DATA,	0x0000},
	{SMART_CONFIG_CMD,	0x0038},{SMART_CONFIG_DATA,	0x00db},
	{SMART_CONFIG_CMD,	0x0039},{SMART_CONFIG_DATA,	0x0000},{SMART_CONFIG_UDELAY,10},
	{SMART_CONFIG_CMD,	0x00ff},{SMART_CONFIG_DATA,	0x0003},
	{SMART_CONFIG_CMD,	0x00b0},{SMART_CONFIG_DATA,	0x1601},
	{SMART_CONFIG_CMD,	0x00b1},{SMART_CONFIG_DATA,	0x0606},
	{SMART_CONFIG_CMD,	0x0050},{SMART_CONFIG_DATA,	0x0002},
	{SMART_CONFIG_CMD,	0x0051},{SMART_CONFIG_DATA,	0x0807},
	{SMART_CONFIG_CMD,	0x0052},{SMART_CONFIG_DATA,	0x0107},
	{SMART_CONFIG_CMD,	0x0053},{SMART_CONFIG_DATA,	0x1800},
	{SMART_CONFIG_CMD,	0x0054},{SMART_CONFIG_DATA,	0x0601},
	{SMART_CONFIG_CMD,	0x0055},{SMART_CONFIG_DATA,	0x0002},
	{SMART_CONFIG_CMD,	0x0056},{SMART_CONFIG_DATA,	0x0707},
	{SMART_CONFIG_CMD,	0x0057},{SMART_CONFIG_DATA,	0x0106},
	{SMART_CONFIG_CMD,	0x0058},{SMART_CONFIG_DATA,	0x1800},
	{SMART_CONFIG_CMD,	0x0059},{SMART_CONFIG_DATA,	0x0501},
	{SMART_CONFIG_CMD,	0x00ff},{SMART_CONFIG_DATA,	0x0000},
	{SMART_CONFIG_CMD,	0x0007},{SMART_CONFIG_DATA,	0x1017},
