...
RICOH_PDATA_INIT(dc3, 0,	600,   1800, 0, DC3_ALWAYS_ON, DC3_BOOT_ON, 1,
...
RICOH_PDATA_INIT(ldo2, 0,	900,   3300, 0, LDO2_ALWAYS_ON, LDO2_BOOT_ON, 1,
		 LDO2_INIT_UV, LDO2_INIT_SLP_UV, LDO2_INIT_ENABLE, 1, 0, 0, 0);
RICOH_PDATA_INIT(ldo3, 0,	900,   3300, 0, LDO3_ALWAYS_ON, LDO3_BOOT_ON, 1,
		 LDO3_INIT_UV, LDO3_INIT_SLP_UV, LDO3_INIT_ENABLE, 1, 0, 0, 0);
RICOH_PDATA_INIT(ldo4, 0,	900,   3300, 0, LDO4_ALWAYS_ON, LDO4_BOOT_ON, 1,
		 LDO4_INIT_UV, LDO4_INIT_SLP_UV, LDO4_INIT_ENABLE, 1, 0, 0, 0);
RICOH_PDATA_INIT(ldo5, 0,	600,   3300, 0, LDO5_ALWAYS_ON, LDO5_BOOT_ON, 1,
