...
static struct jz_battery_platform_data captain_battery_pdata = {
	.info = {
		.max_vol        = 4050,
		.min_vol        = 3600,
		.usb_max_vol    = 4100,
...
static int __init captain_board_init(void)
{
/* dma */
...
/* mmc */
	...
	jz_device_register(&jz_msc0_device, &captain_inand_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &captain_sdio_pdata);
#endif
#ifdef CONFIG_MMC2_JZ4780
	jz_device_register(&jz_msc2_device, &captain_tf_pdata);
#endif
#else
#ifdef CONFIG_MMC0_JZ4780
	jz_device_register(&jz_msc0_device, &captain_tf_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &captain_sdio_pdata);
#endif
...
/* panel and bl */
	...
	platform_device_register(&captain_backlight_device);
#endif
/* lcdc framebuffer*/
...
/* ADC*/
#ifdef CONFIG_BATTERY_JZ4780
	jz_device_register(&jz_adc_device, &captain_battery_pdata);
#endif
/* uart */
...
arch_initcall(captain_board_init);
