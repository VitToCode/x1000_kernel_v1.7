 ...
 *
 * JZ4780 captain board lcd setup routines.
 *
...
static int captain_backlight_init(struct device *dev)
{
	return 0;
}

static void captain_backlight_exit(struct device *dev)
{
}

static struct platform_pwm_backlight_data captain_backlight_data = {
	.pwm_id		= 0,
	.max_brightness	= 255,
	.dft_brightness	= 80,
	.pwm_period_ns	= 10000, /* 100 kHZ */
	.init		= captain_backlight_init,
	.exit		= captain_backlight_exit,
};

/* Backlight Device */
struct platform_device captain_backlight_device = {
	.name		= "pwm-backlight",
	.dev		= {
		.platform_data	= &captain_backlight_data,
	},
};
