...
struct mmc_partition_info captain_inand_partition_info[] = {
...
static struct mmc_recovery_info captain_inand_recovery_info = {
	.partition_info			= captain_inand_partition_info,
	.partition_num			= ARRAY_SIZE(captain_inand_partition_info),
	.permission			= MMC_BOOT_AREA_PROTECTED,
	.protect_boundary		= 21*MBYTE,
};
	
struct jzmmc_platform_data captain_inand_pdata = {
	.removal  			= DONTCARE,
	.sdio_clk			= 0,
