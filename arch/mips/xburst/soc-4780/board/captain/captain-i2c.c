...
static struct jztsc_pin captain_tsc_gpio[] = {
	[0] = {GPIO_CTP_IRQ,		HIGH_ENABLE},
	[1] = {GPIO_CTP_WAKE_UP,	HIGH_ENABLE},
};

#ifdef CONFIG_TOUCHSCREEN_GWTC9XXXB
static struct jztsc_platform_data captain_tsc_pdata = {
	.gpio		= captain_tsc_gpio,
	.x_max		= 800,
	.y_max		= 480,	
};
...
static struct i2c_board_info captain_i2c1_devs[] __initdata = {
...
static struct i2c_board_info captain_i2c2_devs[] __initdata = {
#ifdef CONFIG_SP0838
	{
...
static struct i2c_board_info captain_i2c3_devs[] __initdata = {
#ifdef CONFIG_TOUCHSCREEN_LDWZIC
	{
		I2C_BOARD_INFO("ldwzic_ts", 0x01),
		.platform_data	= &captain_tsc_pdata,
	},
#endif
...
static struct i2c_board_info captain_i2c0_devs[] __initdata = {
#ifdef CONFIG_TOUCHSCREEN_LDWZIC
	{
		I2C_BOARD_INFO("ldwzic_ts", 0x01),
		.platform_data	= &captain_tsc_pdata,
...
static int __init captain_i2c_dev_init(void)
{
...
#if (defined(CONFIG_I2C0_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(0, captain_i2c0_devs, ARRAY_SIZE(captain_i2c0_devs));
#endif

#if (defined(CONFIG_I2C1_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(1, captain_i2c1_devs, ARRAY_SIZE(captain_i2c1_devs));
#endif

#if (defined(CONFIG_I2C_GPIO) || defined(CONFIG_I2C2_JZ4780))
	i2c_register_board_info(2, captain_i2c2_devs, ARRAY_SIZE(captain_i2c2_devs));
#endif
/*
#if (defined(CONFIG_I2C3_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(3, captain_i2c3_devs, ARRAY_SIZE(captain_i2c3_devs));
#endif
*/
	return 0;
}

arch_initcall(captain_i2c_dev_init);
