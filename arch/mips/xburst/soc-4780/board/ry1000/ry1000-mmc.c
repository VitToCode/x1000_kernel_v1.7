...
struct mmc_partition_info ry1000_inand_partition_info[] = {
...
static struct mmc_recovery_info ry1000_inand_recovery_info = {
	.partition_info			= ry1000_inand_partition_info,
	.partition_num			= ARRAY_SIZE(ry1000_inand_partition_info),
	.permission			= MMC_BOOT_AREA_PROTECTED,
	.protect_boundary		= 21*MBYTE,
};
	
struct jzmmc_platform_data ry1000_inand_pdata = {
	.removal  			= DONTCARE,
	.sdio_clk			= 0,
	...
	.recovery_info			= &ry1000_inand_recovery_info,
	.gpio				= NULL,
 ...
 */
static struct card_gpio ry1000_tf_gpio = {
	.cd				= {GPIO_PF(20),		LOW_ENABLE},
	.wp				= {-1,			-1},
	.pwr				= {-1,			-1},
};

struct jzmmc_platform_data ry1000_tf_pdata = {
	.removal  			= REMOVABLE,
	.sdio_clk			= 0,
	.ocr_avail			= MMC_VDD_32_33 | MMC_VDD_33_34,
