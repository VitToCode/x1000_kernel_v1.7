...
#include <linux/hx8389_b11_g.h>
struct platform_device hx8389_b11_g_device = {
	.name		= "hx8389_b11_g-lcd",
	.dev		= {
		.platform_data = NULL,
	},
};
...
struct jzdsi_platform_data jzdsi_pdata = {
	...
	.video_config.h_active_pixels = 540,
	.video_config.h_sync_pixels = 2,	/* min 4 pixels */
	.video_config.h_back_porch_pixels = 64,
	.video_config.h_total_pixels = 540 + 10 + 64 + 24,
	.video_config.v_active_lines = 960,
	.video_config.v_polarity = 0,	/*1:active high, 0: active low */
	.video_config.v_sync_lines = 2,
	.video_config.v_back_porch_lines = 13,
	.video_config.v_total_lines = 960 + 2 + 9 + 13,
	...
	.cmd_list = hx8389_b11_g_cmd_list,
	.cmd_packet_len = 15,
