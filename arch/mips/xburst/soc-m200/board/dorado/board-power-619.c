...
RICOH_PDATA_INIT(ldo7, 0,	900,   3500, 0, 0, 1, 1, 3300, 0, 1, 0, 0, 0); /* power on gsensor on boot. If power down gsensor, the i2c bus can't work. */
RICOH_PDATA_INIT(ldo8, 0,	900,   3500, 0, 0, 1, 1, 1800, 0, 1, 0, 0, 0); /* power on gsensor on boot. If power down gsensor, the i2c bus can't work. */
