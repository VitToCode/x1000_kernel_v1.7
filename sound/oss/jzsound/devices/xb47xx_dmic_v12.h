...
#define __dmic_enable_r()	\
	dmic_set_reg(DMICCR0, 1, DMIC_R_MASK, DMIC_R)
#define __dmic_disable_r()	\
	dmic_set_reg(DMICCR0, 0, DMIC_R_MASK, DMIC_R)
...
#define __dmic_set_rate(n)	\
	dmic_set_reg(DMICCR0, n, DMIC_SR_MASK, DMIC_SR)
...
#define __dmic_get_empty_int()	\
	dmic_get_reg(DMICIMR, DMIC_EMPTY_MSK, DMIC_EMPTY_MASK)
...
#define __dmic_get_prerd_int()	\
	dmic_get_reg(DMICIMR, DMIC_PRERD_MSK, DMIC_PRERD_MASK)
...
#define __dmic_disable_all_int()	\
	dmic_set_reg(DMICIMR, 0x1f, 0x1f, 0)
...
#define __dmic_clear_tur()	\
	dmic_set_reg(DMICINTCR, 0x1f, 0x1f, 0)
...
/*DMICTHRH*/
#define DMIC_THR_H 0
#define DMIC_THR_H_MASK (0x1ffff << DMIC_THR_H)
...
/*DMICTHRL*/
#define DMIC_THR_L 0
#define DMIC_THR_L_MASK (0x1ffff << DMIC_THR_L)
...
/* DMICTRIMMAX */
#define DMIC_M_MAX	0
#define DMIC_M_MAX_MASK	(0xffff << DMIC_M_MAX)
